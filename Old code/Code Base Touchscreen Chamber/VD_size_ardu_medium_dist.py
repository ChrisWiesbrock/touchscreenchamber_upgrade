...
image = visual.GratingStim(win=win, name='grating',
    ...
    ori=0, pos=[-5, 1], units='cm', size=[7.5, 7.5], sf=0.4, phase=0.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    texRes=128, interpolate=True, depth=-1.0)
image_2 = visual.GratingStim(win=win, name='grating',
    tex=u'sin', mask='circle',
    ori=90, pos=[5, 1], units='cm', size=[3.25, 3.25], sf=0.4, phase=0.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    texRes=128, interpolate=True, depth=-1.0)
'''
background = visual.GratingStim(win=win, name='grating',
    tex=u'sin', mask='circle',
    ori=90, pos=[5, 1], units='cm', size=[10, 10], sf=0.15, phase=0.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    texRes=128, interpolate=True, depth=-1.0)
'''
