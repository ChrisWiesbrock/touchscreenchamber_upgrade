...
import numpy as np  # whole numpy lib is available, prepend 'np.'6
...
image = visual.ImageStim(win=win, name='image',
    ...
    ori=90, pos=[-5, 0], units='cm', size=[7, 7],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
image_2 = visual.ImageStim(win=win, name='image_2',
    image=None, mask='circle',
    ori=180, pos=[0, 0], units='cm', size=[7, 7],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
image = visual.GratingStim(win=win, name='grating',
    ...
    ori=0, pos=[-5, 0], units='cm', size=[7.5, 7.5], sf=0.4, phase=0.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    texRes=128, interpolate=True, depth=-2.0)
image_2 = visual.GratingStim(win=win, name='grating',
    tex=u'sin', mask='circle',
    ori=0, pos=[5, 0], units='cm', size=[6, 6], sf=0.4, phase=0.0,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    texRes=128, interpolate=True, depth=-2.0)

background = visual.ImageStim(win=win, name='image',
    ori=0, pos=[0, 0], units='pix', size=[800, 600],
    opacity=1,texRes=128, interpolate=True, depth=-1.0)
...
for thisTrial in trials:
    ...
    if trialnumber<10:
        ...
        if np.random.uniform(0,high=100)<=50:
            ...
            image.setSize([7.5, 7.5])
            image_2.setSize([6, 6])
            image_2.setOpacity(1)
            image.setOpacity(1)
            orientation_difference=90
    ...
    if trialnumber>11:
        ...
        if np.random.randint(0,100,1)>=80:
            rng_back=np.random.randint(0,100,1)
            if rng_back<100:
                catch_trial=1
                background.setImage(r'C:\Users\ZimmerBehavior\Desktop\back_1.png')
                image.setSize([5, 5])
                image_2.setSize([5, 5])
                image.setOpacity(1)
                image_2.setOpacity(1)
        ...
        if image.status == STARTED and mouse_info!=0: #most of one frame period left
            ...
            if mouse_info>0:
                ...
                if correctstim=='left' and trialnumber>0:
                    ...
                    sound_2.play()
                    led_on(serial_obj)
                    lick_detection(win, serial_obj, valve_duration=valve_duration)
                    led_off(serial_obj)
                    #
                ...
                if correctstim=='right' and trialnumber>0:
                    ...
                    lick_delay=trialClock.getTime()
                    mouse.setPos((0,0))
                    lick_detection(win, serial_obj, rewarded=False, valve_duration=valve_duration)
                    #
                    win.color=[0,0,0]
                    win.flip()
    ...
    trials.addData('catch_trial', catch_trial)
